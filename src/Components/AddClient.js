...
export default function AddClient(){
    ...
    const urladd = "http://localhost/prueba_react/probando-app/src/services/agregarInfo.php";
    ...
    useEffect(() => {
        axios.get("http://localhost/prueba_react/probando-app/src/services/obtenerData.php") 
        .then(response => {
