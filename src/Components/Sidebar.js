...
import LogoSeguros from "../Assets/img/LogoSeguros.png";
    ...
    return(
        <>
            <div className="sidebar">
                ...
                <ul>
                    <li>
                        <NavLink to="/Portada" className="text-light rounded py-2 w-100  d-inline-block px-3" activeclassname="active">
