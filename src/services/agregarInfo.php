...
if ($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    //Para tabla cuenta
    $sqlCuenta = "INSERT INTO cuenta(cuenta_email,cuenta_pass,Personas_dni) VALUES ('$email', '$password','$dni')";
    ...
    $cuil = mysqli_real_escape_string($conn, $_POST["data"]['cuil']);
    $num_Agente = mysqli_real_escape_string($conn, $_POST["data"]['num_Agente']);
    ...
    //Talba Cobertura
    $Cobertura = "INSERT INTO cobertura (valor_Cobertura) VALUES ('$valor_cobertura')";
    ...
    //tabla poliza
    $poliza = "INSERT INTO poliza ( condiciones, fecha_Inic, fecha_Fin, cant_Vehiculos, monto_Pagar, num_Empleado, Cliente_cuil, Cobertura_id)
    VALUES ('Limites','$fecha_actual','$fecha_actual_mas_un_anio','1','0','$num_Agente','$cuil','$num_Cobertura')";
